...
external_id_re = re.compile(
    rf'(?P<norole>(?P<courseid>(jy-(CUR-\d+|{uuid_re})|otm-{uuid_re}))-(?P<subgroup>jy-(studysubgroup-\d+|{uuid_re})-)?)(?P<role>teachers|responsible-teachers|students|administrative-persons|studysubgroup-teachers|studysubgroup-students)'
)

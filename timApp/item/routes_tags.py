...
def remove_tag(doc):
    ...
    if tag_type != TagType.Regular:
        ug = UserGroup.get_by_name('teachers')
        if ug in get_current_user_object().groups:
            abort(400, "Removing this tag requires teacher rights.")

...
@dataclass()
class MyPluginHmlModel(
    GenericHtmlModel[MyPluginInputModel, MyPluginMarkUp, MyPluginStateModel]
):
...
def reqs_handle() -> PluginReqs:
    return {"js": ["peerReviewTable"], "multihtml": True}
...
register_html_routes(my_plugin, class_schema(MyPluginHmlModel), reqs_handle)

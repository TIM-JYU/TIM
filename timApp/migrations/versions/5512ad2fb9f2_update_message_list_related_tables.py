...
def upgrade():
    ...
    op.add_column('messagelist', sa.Column('default_reply_type', sa.Enum('NOCHANGES', 'ADDLIST', name='replytolistchanges'), nullable=True))
    ...
    op.add_column('messagelist_member', sa.Column('join_method', sa.Enum('DIRECT_ADD', 'INVITED', 'JOINED', name='memberjoinmethod'), nullable=True))

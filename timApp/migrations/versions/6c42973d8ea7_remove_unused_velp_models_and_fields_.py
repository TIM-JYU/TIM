...
def downgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["doc_id"], ["block.id"], name="importedvelpgroups_doc_id_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["user_group"], ["usergroup.id"], name="importedvelpgroups_user_group_fkey"
        ),
        sa.ForeignKeyConstraint(
            ["velp_group_id"],
            ["velpgroup.id"],
            name="importedvelpgroups_velp_group_id_fkey",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["group_label_id"],
            ["velpgrouplabel.id"],
            name="labelinvelpgroup_group_label_id_fkey",
        ),
        sa.ForeignKeyConstraint(
            ["velp_group_id"],
            ["velpgroup.id"],
            name="labelinvelpgroup_velp_group_id_fkey",
        ),
        sa.PrimaryKeyConstraint(
            "velp_group_id", "group_label_id", name="labelinvelpgroup_pkey"
        ),
    )
    ...
    op.add_column(
        "velp", sa.Column("icon_id", sa.INTEGER(), autoincrement=False, nullable=True)
    )
    ...
    op.create_foreign_key(
        "annotation_icon_id_fkey", "annotation", "icon", ["icon_id"], ["id"]
    )

...
def upgrade():
    ...
    op.add_column('messagelist_distribution', sa.Column('channel', sa.Enum('TIM_MESSAGE', 'EMAIL_LIST', name='channel'), nullable=True))
...
def downgrade():
    ...
    op.add_column('messagelist_distribution', sa.Column('channel_id', postgresql.ENUM('TIM_MESSAGE', 'EMAIL_LIST', name='channel'), autoincrement=False, nullable=True))

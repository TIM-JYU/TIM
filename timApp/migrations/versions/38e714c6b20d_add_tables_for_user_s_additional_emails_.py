...
def upgrade():
    ...
    sa.Column('verification_type', sa.Enum('LIST_JOIN', 'EMAIL_OWNERSHIP', name='verificationtype'), nullable=True),
...
def downgrade():
    ...
    sa.Enum(name='verificationtype').drop(op.get_bind(), checkfirst=False)
    # ### end Alembic commands ###

...
def upgrade():
    ...
    op.create_table('enrollmenttype',
    ...
    sa.ForeignKeyConstraint(['creator_user_id'], ['useraccount.id'], ),
    ...
    sa.Column('enroll_type_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['enroll_type_id'], ['enrollmenttype.enroll_type_id'], ),

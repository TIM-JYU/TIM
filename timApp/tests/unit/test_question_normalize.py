...
class QuestionJsonNormalizeTest(unittest.TestCase):
                    ...
                    "ROWS": [
                        {
                            ...
                            "type": "question",
                            "text": "pallo",
                            "COLUMNS": [{"id": 0, "type": "answer", "rowId": 0}],
                        },
                        {
                            "id": 1,
                            "type": "question",
                            "text": "x",
                            "COLUMNS": [{"id": 0, "type": "answer", "rowId": 1}],
                        },
                        {
                            "id": 2,
                            "type": "question",
                            "text": "y",
                            "COLUMNS": [{"id": 0, "type": "answer", "rowId": 2}],
                        },
                    ],
                },
            }
        ...
        result2 = normalize_question_json(
            {
                ...
                "json": {
                    ...
                    "rows": [
                        "Tulee yksi pallo (keltainen)",
                        {
                            "text": "Tulee kaksi keltaista palloa",
                            "columns": [{"rowId": 1, "id": 0, "type": "answer"}],
                            "id": 1,
                            "type": "question",
                        },
                        {
                            "text": "N\u00e4kyy 1 valkoinen ja 1 punainen pallo",
                            "columns": [{"rowId": 2, "id": 0, "type": "answer"}],
                            "id": 2,
                            "type": "question",
                        },
                    ],
                ...
                "json": {
                    "data": {
                        "rows": [
                            {
                                "text": "3 3 3",
                                "columns": [{"rowId": 0, "id": 0, "type": "answer"}],
                                "id": 0,
                                "type": "question",
                            },
                            {
                    ...
                    "rows": [
                        {
                            ...
                            "columns": [{"id": 0, "rowId": 0, "type": "answer"}],
                            "id": 0,
                            "type": "question",
                        },
                        {
                            "text": "Ihan jees :)",
                            "columns": [{"id": 0, "rowId": 1, "type": "answer"}],
                            "id": 1,
                            "type": "question",
                        },
                    ],
    ...
    def test_invalid(self):
        ...
        self.assertEqual(
            ...
            normalize_question_json({"questionTitle": ""}),
        )
        self.assertEqual(
            {
                "answerFieldType": "text",

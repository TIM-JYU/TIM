...
class QuestionTest(BrowserTest):
    def test_questions(self):
        ...
        self.do_question_test(
            ...
            expected_answer='[["2"]]',
            expected_points=1,
            expected_yaml=create_yaml('radio', 'radio-vertical', choices, points_str='1:3;2:1;4:0'),
            headers=[],
            points=points,
            questiontype='radio',
        ...
        self.do_question_test(
            ...
            expected_points=3,
            expected_yaml=create_yaml('checkbox', 'checkbox-vertical', choices, points_str='1:3;2:1;4:0'),
            headers=[],
            points=points,
        ...
        self.do_question_test(
            ...
            expected_yaml=create_yaml('checkbox', 'matrix', choices, headers=matrixheaders,
                                      points_str='1:3;3:0;4:-1|2:-5|4:2|1:1|3:0', matrix_type='checkbox'),
        ...
        self.do_question_test(
            ...
            expected_yaml=create_yaml('radio', 'matrix', choices, headers=matrixheaders,
                                      points_str='1:3;3:0;4:-1|2:-5|4:2|1:1|3:0', matrix_type='radiobutton-horizontal'),
            headers=matrixheaders,
            points=['3', '', '0', '-1',
                    '', '-5', '', '',
                    '', '', '', '2',

...
class VelpTest(BrowserTest):
    def test_velps(self):
        ...
        * The created velp appears in the list of velps
        ...
        velp_selection_element = self.drv.find_element(by=By.CSS_SELECTOR, value='#velpSelection')
        ...
        new_velp_element: WebElement = velp_selection_element.find_element(by=By.CSS_SELECTOR, value=new_velp_selector)
        self.assert_same_screenshot(new_velp_element, 'velps/create_new_velp_empty')

        velp_content_input: WebElement = new_velp_element.find_element(by=By.CSS_SELECTOR, value='input[ng-model="$ctrl.velp.content"]')
        velp_content_input.send_keys('first velp')

        velp_points_input: WebElement = new_velp_element.find_element(by=By.CSS_SELECTOR, value='input[ng-model="$ctrl.velp.points"]')
        velp_points_input.send_keys('2')

        velp_comment_input: WebElement = new_velp_element.find_element(by=By.CSS_SELECTOR, value=
        ...
        velp_visible_input = Select(new_velp_element.find_element(by=By.CSS_SELECTOR, value=
        ...
        save_button: WebElement = new_velp_element.find_element(by=By.CSS_SELECTOR, value='input[type="submit"]')
        save_button.click()

...
class InlinePluginTest(TimRouteTest):
    ...
    # # TODO: Create browser tests for wrapping
...
<div tabindex="0" class="parContent">
            <p>
                <em>Hello</em> <tim-plugin-loader type="full" answer-id="" class="pluginpali inlineplugin" tag="span" id="{d.id}.t1.Lm7y6R7n5XIb" dataplugin="/pali" task-id="{d.id}.t1">
                <pali-runner json="{self.make_base64(
        expected_json)}"></pali-runner></tim-plugin-loader>, <span class="error" ng-non-bindable>Plugin nonexistent error: Plugin does not exist.</span> and <tim-plugin-loader type="full" answer-id="" class="pluginpali inlineplugin" tag="span" id="{d.id}.t2.Lm7y6R7n5XIb" dataplugin="/pali" task-id="{d.id}.t2"><pali-runner json="{self.make_base64(
...
<p>
<em>Hello</em>
<tim-plugin-loader type="full" answer-id="" class="pluginpali inlineplugin" tag="span" id="{d.id}.t1.Lm7y6R7n5XIb" dataplugin="/pali" task-id="{d.id}.t1">
...
<tim-plugin-loader type="full" answer-id="{aid}" class="pluginpali inlineplugin" tag="span" id="{d.id}.t2.Lm7y6R7n5XIb" dataplugin="/pali" task-id="{d.id}.t2">
<pali-runner json="{self.make_base64(
        expected_json2)}"></pali-runner></tim-plugin-loader>
<span class="math inline">\(x\)</span>
</p>
...
<p>
                Hi
<tim-plugin-loader type="full" answer-id="" class="pluginpali inlineplugin" tag="span" id="{d.id}.t3.spOMcE20X2aX" dataplugin="/pali" task-id="{d.id}.t3">
...
<div tabindex="0" class="parContent">
<p>
<tim-plugin-loader type="full" answer-id="" class="pluginpali inlineplugin" tag="span" id="{d.id}.t4.Se0s8FDLbhOp" dataplugin="/pali" task-id="{d.id}.t4">
<pali-runner json="{self.make_base64(expected_json)}"></pali-runner>
</tim-plugin-loader>
</p>
</div>
...
<div tabindex="0" class="parContent">
    <p>
        <tim-plugin-loader type="full" answer-id="" class="pluginpali inlineplugin" tag="span" id="{d.id}.t5.a3Xuyg1PF1l1" dataplugin="/pali" task-id="{d.id}.t5">
...
<div tabindex="0" class="parContent">
    <p>
        a
        <tim-plugin-loader type="full" answer-id="" class="pluginpali inlineplugin" tag="span" id="{d.id}.x.a3Xuyg1PF1l1" dataplugin="/pali" task-id="{d.id}.x">
            <div class="pluginError">
                The following fields have invalid values:
                <ul>
                    <li>

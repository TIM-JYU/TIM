...
# Second heading level 1
        ...
        self.assertEqual(
            [
                (
                    {"id": "heading-level-1", "level": 1, "text": "Heading level 1"},
                    [
                        {
                            "id": "heading-level-2",
                            "level": 2,
                ...
                (
                    {
                        "id": "second-heading-level-1",
                        "level": 1,
                        "text": "Second heading level 1",
                    },
                    [],
                ),
            ],
...
# Second heading level 1
        ...
        self.assertEqual(
            [
                (
                    {"id": "heading-level-1", "level": 1, "text": "1. Heading level 1"},
                    [],
                ),
                (
                    ...
                    [
                        {
                            "id": "heading-level-2",
                            "level": 2,
                            "text": "1.1. Heading level 2",
                        },
                        {
                            "id": "second-heading-level-2",
                            "level": 2,
                            "text": "1.2. Second heading level 2",
                        },
                        {
                            "id": "heading-level-3",
                            "level": 3,
                            "text": "1.2.1 Heading level 3",
                        },
                    ],
                ),
                (
                    ...
                    [
                        {
                            "id": "heading-level-2",
                            "level": 2,
                            "text": "[ERROR] Heading level 2",
                        },
                        {
                            "id": "second-heading-level-2",
                            "level": 2,
                            "text": "[ERROR] Second heading level 2",
                        },
                        {
                            "id": "heading-level-3",
                            "level": 3,
                            "text": "[ERROR] Heading level 3",
                        },
                    ],
                ),
                (
...
# Second heading level 1
    ...
    def test_index_numeric_headings_with_newline(self):
        """Test that numeric indexing works with blocks that contain newlines."""
        self.login_test1()
...
# Second heading level 1
            ...
            [
                (
                    ...
                    [
                        ...
                        {"id": "unnumbered", "level": 2, "text": "Unnumbered"},
                        {
                            "id": "second-heading-level-3",
                            "level": 3,
                            "text": "Second heading level 3",
                        },
                    ],
                ),
                (
                    ...
                    [
                        {
                            "id": "heading-level-3",
                            "level": 3,
                            "text": "1.0.1 Heading level 3",
                        },
                        {"id": "unnumbered", "level": 2, "text": "Unnumbered"},
                        {
                            "id": "second-heading-level-3",
                            "level": 3,
                            "text": "1.0.2 Second heading level 3",
                        },
                    ],
                ),
                (
        ...
        self.assertEqual(
            [
                ({"id": "new-heading", "level": 1, "text": "1. New heading"}, []),
                (
                    ...
                    [
                        {
                            "id": "heading-level-3",
                            "level": 3,
                            "text": "2.0.1 Heading level 3",
                        },
                        {"id": "unnumbered", "level": 2, "text": "Unnumbered"},
                        {
                            "id": "second-heading-level-3",
                            "level": 3,
                            "text": "2.0.2 Second heading level 3",
                        },
                    ],
                ),
                (
...
# Same
        ...
        self.assertEqual(
            [
                ...
                ({"id": "same-3", "level": 1, "text": "Same"}, []),
                ({"id": "other", "level": 1, "text": "Other"}, []),
                ({"id": "other-1", "level": 1, "text": "Other"}, []),
                ({"id": "same-4", "level": 1, "text": "Same"}, []),
            ],
            doc.get_index(default_view_ctx),
        )
    ...
    def test_heading_preview(self):
        self.login_test1()
        d = self.create_doc(
            settings={"auto_number_headings": True}, initial_par=["# a", "# b", "# c"]
        )
        self.check_doc_preview(d)

    def test_heading_preview_translation(self):
        self.login_test1()
        orig = self.create_doc(
            settings={"auto_number_headings": True}, initial_par=["# a", "# b", "# c"]
        )
    ...
    def test_heading_preview_translation_nonumber(self):
        self.login_test1()
        orig = self.create_doc(
            settings={"auto_number_headings": True},
        ...
        e = self.post_preview(
            d,
            text=f"# x {{r=tr rp={orig_par.get_id()}}}",
            par=pars[2],
            json_key="texts",
            as_tree=True,
        )

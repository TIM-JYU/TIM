...
class RelevanceTest(TimRouteTest):
    ...
    def test_set_relevance_and_get(self):
        ...
        self.get(f'/items/relevance/get/{d.id}', expect_content={'block_id': d.id, 'relevance': 100})
    ...
    def test_set_and_replace_relevance_and_get(self):
        ...
        self.get(f'/items/relevance/get/{d.id}', expect_content={'block_id': d.id, 'relevance': 50})

...
class VelpTest(TimRouteTest):
    ...
    def test_velp(self):
        ...
        j = self.json_post(f'/{str(doc1_id)}/create_default_velp_group')
        ...
        j = self.json_post(f'/{str(doc1_id)}/create_velp_group',
        ...
        self.json_post(f'/{str(doc1_id)}/update_velp', test_data)
        resp = self.get(f'/{str(doc1_id)}/get_velps')
        ...
        test_data = {'content': 'Is Zorg now', 'velp_groups': [default_group_id], 'language_id': 'FI', 'id': velp_id,
                     'labels': [label_id]}
        self.json_post(f'/{str(doc1_id)}/update_velp', test_data)
        resp = self.get(f'/{str(doc1_id)}/get_velp_labels')

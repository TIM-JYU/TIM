...
""",
        ...
        self.assertEqual(
            "YAML would be invalid after replacement, so not doing anything",
            repls[0].error,
        )
        self.assertEqual(
            "YAML is invalid before replacement, so not doing anything", repls[1].error
        )
        self.assertEqual(
            "YAML would be invalid after replacement, so not doing anything",
            repls[2].error,

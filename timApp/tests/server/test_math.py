...
\usetikzlibrary{shapes}
        """})
        self.assert_same_html(self.get(d.url, as_tree=True).cssselect('.parContent')[1], diamond_html)
...
$$""")
        ...
        self.assert_same_html(t.cssselect('.parContent')[0], diamond_html)

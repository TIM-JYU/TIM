...
from timApp.messaging.timMessage.internalmessage_models import InternalMessageDisplay, InternalMessage
...
class SendMessageTest(TimRouteTest):
    def test_send_message(self):
        ...
        self.login_test1()
        self.get('/view/messages/tim-messages', expect_status=200)  # tim-messages folder created successfully
        ...
        self.get(f'/view/{msg_doc.name}', expect_status=200)  # document for message created successfully

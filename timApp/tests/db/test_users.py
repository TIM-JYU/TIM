...
from timdb.userutils import grant_access, get_view_access_id
...
class UserTest(TimDbTest):
    def test_create_user(self):
        ...
        # Testing view access
        self.assertFalse(user.has_view_access(test_block_id))
        user.groups.append(g3)
        db.session.commit()
        grant_access(gid3, test_block_id, 'view')
        self.assertTrue(user.has_view_access(test_block_id))
        self.assertFalse(user.has_edit_access(test_block_id))
        self.assertFalse(user.has_teacher_access(test_block_id))
        self.assertFalse(user.has_manage_access(test_block_id))
        self.assertFalse(user.has_seeanswers_access(test_block_id))
        ...
        self.assertTrue(user.has_edit_access(test_block_id))
        self.assertTrue(user.has_view_access(test_block_id))
        self.assertFalse(user.has_teacher_access(test_block_id))
        self.assertFalse(user.has_manage_access(test_block_id))
        self.assertFalse(user.has_seeanswers_access(test_block_id))
        ...
        self.assertTrue(user.has_manage_access(test_block_id))
        self.assertTrue(user.has_edit_access(test_block_id))
        self.assertTrue(user.has_view_access(test_block_id))
        self.assertTrue(user.has_teacher_access(test_block_id))
        self.assertTrue(user.has_seeanswers_access(test_block_id))
        ...
        self.assertDictEqual({1: test_block.owner_access,
                              2: test_block_2.owner_access}, user.get_viewable_blocks())
        for bid in (test_block_id, test_block_id2):
            self.assertTrue(user.has_manage_access(bid))
            self.assertTrue(user.has_edit_access(bid))
            self.assertTrue(user.has_view_access(bid))
            self.assertTrue(user.has_teacher_access(bid))
            self.assertTrue(user.has_seeanswers_access(bid))

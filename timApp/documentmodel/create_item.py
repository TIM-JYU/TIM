...
def copy_document(source: DocInfo, target: DocInfo, copy_def_rights=True):
    ...
    for tr in source.translations:  # type: Translation
        ...
        if copy_def_rights and not tr.is_original_translation:

...
BLOCKTYPES = collections.namedtuple('blocktypes', ('DOCUMENT', 'COMMENT', 'NOTE', 'ANSWER', 'IMAGE', 'READING', 'FOLDER', 'FILE'))
blocktypes = BLOCKTYPES(0, 1, 2, 3, 4, 5, 6, 7)
        ...
        for row in rows:
            ...
            if read_ver != doc_ver:
                ...
                if mapping is not None and (table == 'UserNotes' or mapping[0] not in mapped_pars):
                    ...
                    modified = mapping[1] or bool(row['deprecated'])

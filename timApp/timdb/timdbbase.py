...
class TimDbBase(object):
    ...
    @contract
    def insertBlockToDb(self, name: 'str', owner_group_id: 'int', block_type: 'int', block_id: 'int|None'=None) -> 'int':
        """Inserts a block to database.

        :param block_id: The id of the block or None if it should be autogenerated.
        ...
        if block_id is None:
            ...
            cursor.execute("""
                INSERT INTO Block (id, description, UserGroup_id, type_id, created, modified)
                VALUES (?, ?,?,?, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)""",
                           [block_id, name, owner_group_id, block_type])

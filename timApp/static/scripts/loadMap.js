$(document).ready(function () {
    ...
    $.getJSON("/generateMap", function (newJson) {
        ...
        loadImages(sources, function (images) {
            ...
            function drawInfo(x, y, tile) {
                ...
                // TESTATAAN PROPERTYN VAIHTOA!!!

                title.html("<a href='" + json.layers[tile.layerNo].properties.L + "'>" + json.layers[tile.layerNo].properties.T + "</a>");
                if(json.layers[tile.layerNo].properties.M !== 0) {
                    description.html("Pisteet: " + json.layers[tile.layerNo].properties.P + "/" +
                        json.layers[tile.layerNo].properties.M + "<br>Pisteet yhteensÃ¤: " + totalPoints + "/" + totalMax);
                } else {
                    description.html("Pisteet yhteensÃ¤: " + totalPoints + "/" + totalMax);
                }

...
timApp.directive("reviewEditor", ['Upload', '$http', '$sce', '$compile', '$window', '$localStorage', '$timeout',
    function (Upload, $http, $sce, $compile, $window, $localStorage, $timeout) {
        return {
            templateUrl: "/static/templates/reviewEditor.html",
            restrict: 'E',
            scope: {
                saveUrl: '@',
                deleteUrl: '@',
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $(document).on('webkitfullscreenchange mozfullscreenchange fullscreenchange MSFullscreenChange', function (event) {
                    var editor = $($element).find("#reviewEditor").get(0);
                ...
                $scope.goFullScreen = function () {
                    var div = $($element).find("#reviewEditor").get(0);
                    if (!document.fullscreenElement &&    // alternative standard method
                        !document.mozFullScreenElement && !document.webkitFullscreenElement && !document.msFullscreenElement) {

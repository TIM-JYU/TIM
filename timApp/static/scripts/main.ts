requirejs.config({
    ...
    paths: {
        ...
        'angular-ui-ace': 'angular-ui-ace/src/ui-ace',
        ...
        'ace-lang': 'ace-builds/src-min/ext-language_tools',
    },
    packages: [{
        name: 'moment',
        location: 'moment',
    ...
    shim: {
        ...
        'tim/directives/bookmarks': {deps: ['tim/app']},

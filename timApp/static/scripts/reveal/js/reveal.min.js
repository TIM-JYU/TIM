...
(function( root, factory ) {
	...
	function updateSlides( selector, index ) {
		...
		if( slidesLength ) {
			...
			if (scale < 1 && oldscale == "none") {
                $(slide).css('transform', 'scale(' + scale + ')');
                $(slide).css('transform-origin', '50% 0');
                $(slide).css('-ms-transform', 'scale(' + scale + ')');
                $(slide).css('-ms-transform-origin', '50% 0');
                $(slide).css('-webkit-transform', 'scale(' + scale + ')');
                $(slide).css('-webkit-transform-origin', '50% 0');
                $(slide).css('-moz-transform', 'scale(' + scale + ')');
                $(slide).css('-moz-transform-origin', '50% 0');
			}

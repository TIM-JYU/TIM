...
(function( root, factory ) {
	...
	function setupDOM() {
		...
		createSingletonNode( dom.wrapper, 'aside', 'controls',
            ...
            '<div class="fullscreen enabled"></div>');
        ...
        dom.controlsFullScreen = toArray( document.querySelectorAll( '.fullscreen' ) );
	...
	function addEventListeners() {
		...
		pointerEvents.forEach( function( eventName ) {
            ...
            dom.controlsFullScreen.forEach( function( el ) { el.addEventListener( eventName, onNavigateFullScreenClicked, false ); } );
		} );
	...
	function slide( h, v, f, o ) {
        ...
        if (o == 'remote' && h == indexhBefore && v == indexvBefore) return;
    ...
    function onNavigateFullScreenClicked( event ) { event.preventDefault(); onUserInput(); enterFullscreen(); }

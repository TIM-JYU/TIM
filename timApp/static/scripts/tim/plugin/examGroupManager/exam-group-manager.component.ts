                    ...
                    <tabset class="merged">
                        <tab *ngFor="let group of visibleGroups"
                            ...
                            <tim-alert *ngIf="group.examState > 0" severity="warning" i18n>
                                ...
                                Stop the exam and disable login codes in section '3. Manage exams' to enable showing
                                answers.
                            </tim-alert>
                            <tim-alert *ngIf="group.currentExamDoc && group.currentExamDoc !== group.examDocId"
                                       severity="warning" i18n>
                                You can only show answers for the main exam
                                ({{ examByDocId.get(group.examDocId!)?.name }}) and not for the practice exam.

...
@dataclass
class SaveUserLLMPolicyParams(GenericParams):
    user_data: UserData
...
def get_user_llm_policy_data(params: GenericParams) -> dict:
    """
...
def save_user_llm_policy(params: SaveUserLLMPolicyParams) -> dict:
    document_id = params.document_id
...
register_route(
    asktim,
    "post",
    "getUserLLMPolicyData",
    GenericParams,
    get_user_llm_policy_data,
)
register_route(
    asktim,
    "post",
    "saveUserLLMPolicy",
    SaveUserLLMPolicyParams,
    save_user_llm_policy,
)
register_route(
    asktim,
    "post",

...
class LLMRule(db.Model):
    ...
    policy: Mapped[list["LLMPolicy"]] = relationship(
        "LLMPolicy", back_populates="llm_rule", cascade="all, delete-orphan"
    )
    usage: Mapped[list["LLMUsage"]] = relationship(
        "LLMUsage", back_populates="llm_rule", cascade="all, delete-orphan"
    )

...
class SimpleBarChart {
    ...
    public x_off: number = 0;
    public y_off: number = 0;
    public x_scale: any;
    public y_scale: any;
    public chart: any;
    constructor(public svg_id: any, public x_labels: string[], public y_max: number, public xlabel: string, public ylabel: string, public invert_color?: boolean ) {
	...
	var bar_spacing: number = this.width / this.x_max;;
	var bar_width: number = bar_spacing * .6;
	var y_scale = this.y_scale;
	var y_max = this.y_max;

	var data: number[] = new Array<number>();
	for(var i: number = 0; i < this.x_labels.length; ++i)
	    data.push(0.0);

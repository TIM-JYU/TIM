...
@fieldapp.app.route('/cb/multihtml/', methods=['post'])
...
@fieldapp.app.route('/cb/answer/', methods=['put'])
...
@fieldapp.app.route('/answer/', methods=['put'])
@use_args(TextfieldAnswerSchema(), locations=("json",))

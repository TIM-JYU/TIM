...
class NumericfieldController extends PluginBase<t.TypeOf<typeof NumericfieldMarkup>, t.TypeOf<typeof NumericfieldAll>, typeof NumericfieldAll> implements ITimComponent {
    ...
    $onInit() {
        super.$onInit();
        this.numericvalue = valueOr(this.attrsall.numericvalue, this.attrs.initnumber || undefined || (this.attrs.initnumber == 0 && 0) );
    ...
    */
     ...
     */
    initCode() {
        this.numericvalue = this.attrs.initnumber || undefined || (this.attrs.initnumber == 0 && 0)
        this.initialValue = this.numericvalue;

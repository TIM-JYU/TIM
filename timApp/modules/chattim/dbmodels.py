...
class LLMRule(db.Model):
    ...
    policy: Mapped[list["Policy"]] = relationship("Policy", back_populates="llm_rule", cascade="all, delete-orphan")
    usage: Mapped[list["Usage"]] = relationship("Usage", back_populates="llm_rule", cascade="all, delete-orphan")

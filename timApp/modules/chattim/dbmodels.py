...
class LLMRule(db.Model):
    ...
    # teachers: Mapped[list["UserGroup"]] = relationship("UserGroup", back_populates="llm_rule")
    current_mode: Mapped[str] = mapped_column(String, default="summarizing") # summarizing or creative
...
class Usage(db.Model):
    ...
    context: Mapped[LLMRule] = relationship("LLMRule", back_populates="usage")

System.register(["angular", "io-ts", "tim/plugin/util", "tim/util/ngimport", "tim/util/utils"], function (exports_1, context_1) {
    ...
    var angular_1, t, util_1, ngimport_1, utils_1, utils_2, paliApp, moduleDefs, PaliMarkup, PaliAll, PaliController;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_1("moduleDefs", moduleDefs = [paliApp]);
            ...
            PaliAll = t.intersection([
                ...
                util_1.GenericPluginTopLevelFields,
            ...
            paliApp.component("paliRunner", {
                bindings: util_1.pluginBindings,

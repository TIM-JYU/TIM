...
(function ($) {
    ...
    // addSound function added by vkaravir Jan 21st 2014
    $.ionSound.addSound = function(soundConf) {
        // only add the sound once
        if (sounds[soundConf]) { return; }
        settings.sounds.push(soundConf);
        createSound(soundConf);
    };

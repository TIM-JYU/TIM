...
def _migrate_variables(config: TIMConfig) -> None:
    ...
    variable_remap = {
        "TIM_HOST": ("tim", "host"),
        "RUN_MAILMAN_DEV": ("mailman", "dev"),
        "DRAG_DEV_COMMAND": ("drag", "dev"),
        "PG_SHM_SIZE": ("postgresql", "shm_size"),
        "PALI_DEV_COMMAND": ("pali", "dev"),
        ...
        "TEXTFIELD_DEV_COMMAND": ("fields", "dev"),
        "PG_MAX_CONNECTIONS": ("postgresql", "max_connections"),
        "CADDY_EXTRA_TIM_CONFIG": ("caddy", "extra_tim_config"),
        "JSRUNNER_DEV_COMMAND": ("jsrunner", "dev"),
        "CSPLUGIN_DEV_COMMAND": ("csplugin", "dev"),
        "FEEDBACK_DEV_COMMAND": ("feedback", "dev"),
        "SVNPLUGIN_DEV_COMMAND": ("showfile", "dev"),
        "CADDY_DOMAINS": ("caddy", "domains"),
        "CADDY_EXTRA_CONFIG": ("caddy", "extra_config"),
        "LOG_DIR": ("tim", "log_dir"),
        "IMAGEX_DEV_COMMAND": ("imagex", "dev"),
